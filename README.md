<p align="center">
  <img src=".github/ScaleSwitch.png" alt="ScaleSwitch icon" width="128">
</p>
...
<a href="https://www.star-history.com/?repos=infinition%2FScaleSwitch&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=infinition/ScaleSwitch&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=infinition/ScaleSwitch&type=date&legend=top-left" />
